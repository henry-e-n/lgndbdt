...
# from settings import fname, dsinfo
...
long_calib_path = "/global/cfs/cdirs/majorana/projecta/majorana/users/nickruof/long_cals"
long_calib_files = ["ds6a_lcals.txt", "ds6b_lcals.txt","ds6c_lcals.txt"]
random_seed = 4254456456
...
def summary_legacy(shap_values, features=None, feature_names=None, max_display=None, plot_type=None,
                 ...
                 color_bar=False, plot_size="auto", layered_violin_max_num_bins=20, class_names=None,
                 class_inds=None,
    ...
    if color is None:
        if plot_type == 'layered_violin':
            ...
            color = matplotlib.cm.get_cmap("coolwarm")
