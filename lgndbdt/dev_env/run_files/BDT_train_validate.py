...
def BDT_train_validate(detector_name, target_peak, source_location, train_features, match_features, match_step, bdt_thresh = 0.55, avse_thresh = 969, split_ratio = 0.3, validate="split", augment = True, plots=True):
    ...
    if plots:
        ...
        for i in tqdm(range(6), 
            ...
            if i == 0:
                ...
                y_pred = gbm.predict(X_test[:,:len(train_features)], num_iteration=gbm.best_iteration) ### check this replace GBM with MSBDT
