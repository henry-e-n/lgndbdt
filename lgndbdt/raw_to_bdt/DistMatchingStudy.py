...
def run_BDT2(bdt_thresh = 0.55, avse_thresh = 969, SEPorFEP="SEP", sourceLoc = "top", validate="split", augment = True, plots=True):
    ...
    def getAUC(distributionMatching):
        ...
        tpr, fpr, bdtauc, bdtauc_side = getROC_sideband(Y_test, y_pred, sig_sideband_pred, bkg_sideband_pred, sigavse, bkgavse)
        return bdtauc, bdtauc_side
    return
